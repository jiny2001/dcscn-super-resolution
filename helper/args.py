...
# Model
flags.DEFINE_integer("filters", 64, "Number of CNN Filters")
...
flags.DEFINE_integer("last_cnn_size", 3, "Size of Last CNN filters")
flags.DEFINE_integer("last_layers", 1, "Last CNN Layers")
flags.DEFINE_integer("last_filters", 32, "Last CNN Filters")
...
flags.DEFINE_boolean("batch_norm", True, "batch normalization")
...
# Training
flags.DEFINE_string("initializer", "stddev",
                    "Initializer for weights can be [uniform, stddev, xavier, he, identity, zero]")  # he
flags.DEFINE_float("weight_dev", 0.01, "Initial weight stddev (won't be used when you use he or xavier initializer)")
flags.DEFINE_float("l2_decay", 0, "l2_decay")  # 0.001
...
flags.DEFINE_integer("batch_image_size", 32, "Image size for mini-batch") # size of training image size
flags.DEFINE_integer("stride_size", 0, "Stride size for mini-batch. If it is 0, use half of batch_image_size")
flags.DEFINE_float("clipping_norm", 0, "Norm for gradient clipping")  # 5
...
flags.DEFINE_string("evaluate_dataset", "set14", "Directory for evaluate dataset [set5, set14, bsd100, urban100, all]")
...
flags.DEFINE_integer("training_data_num", 20000, "Number of training on each epoch")

# Image Processing
flags.DEFINE_integer("scale", 2, "Scale factor for Super Resolution (can be 2 or more)")
flags.DEFINE_float("input_max", 255, "For normalize image pixel value")
flags.DEFINE_float("output_max", 255, "For normalize image pixel value")
flags.DEFINE_float("output_min", 0, "For normalize image pixel value")
...
flags.DEFINE_string("log_header", "test", "note for the trial")
...
flags.DEFINE_boolean("save_weights", False, "Save weights and biases")  # True
