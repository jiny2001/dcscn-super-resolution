...
flags.DEFINE_string("resampling_method", "bicubic", "interpolation method for resampling")
flags.DEFINE_float("dropout", 0.8, "Dropout value. Don't use if it's 1.0.")
...
flags.DEFINE_float("clipping_norm", 0, "Norm for gradient clipping")
