# this file is from https://github.com/anderskm/exportTensorFlowLog/
...
def exitWithUsage():
    ...
    print(
        '   <summaries>              - (Optional) Comma separated list of summaries to save in output-folder. Default: ' + ', '.join(
            summariesDefault))
    print(' ')
    sys.exit()
