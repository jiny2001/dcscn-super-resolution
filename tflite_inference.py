...
def main(not_parsed_args):
    ...
    # model.load_and_evaluate_tflite_graph(FLAGS.output_dir, FLAGS.data_dir, FLAGS.test_dataset)
    load_and_evaluate_tflite_graph(FLAGS.output_dir, FLAGS.data_dir, FLAGS.test_dataset)

def load_and_evaluate_tflite_graph(output_dir, data_dir, test_data, model_path='./model_to_freeze/optimized_graph.lite'):
